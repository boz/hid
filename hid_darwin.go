...
var (
	vIOReturnSuccess           int64 = C.kIOReturnSuccess
	vIOReturnError             int64 = C.kIOReturnError
	vIOReturnNoMemory          int64 = C.kIOReturnNoMemory
	vIOReturnNoResources       int64 = C.kIOReturnNoResources
	vIOReturnIPCError          int64 = C.kIOReturnIPCError
	vIOReturnNoDevice          int64 = C.kIOReturnNoDevice
	vIOReturnNotPrivileged     int64 = C.kIOReturnNotPrivileged
	vIOReturnBadArgument       int64 = C.kIOReturnBadArgument
	vIOReturnLockedRead        int64 = C.kIOReturnLockedRead
	vIOReturnLockedWrite       int64 = C.kIOReturnLockedWrite
	vIOReturnExclusiveAccess   int64 = C.kIOReturnExclusiveAccess
	vIOReturnBadMessageID      int64 = C.kIOReturnBadMessageID
	vIOReturnUnsupported       int64 = C.kIOReturnUnsupported
	vIOReturnVMError           int64 = C.kIOReturnVMError
	vIOReturnInternalError     int64 = C.kIOReturnInternalError
	vIOReturnIOError           int64 = C.kIOReturnIOError
	vIOReturnCannotLock        int64 = C.kIOReturnCannotLock
	vIOReturnNotOpen           int64 = C.kIOReturnNotOpen
	vIOReturnNotReadable       int64 = C.kIOReturnNotReadable
	vIOReturnNotWritable       int64 = C.kIOReturnNotWritable
	vIOReturnNotAligned        int64 = C.kIOReturnNotAligned
	vIOReturnBadMedia          int64 = C.kIOReturnBadMedia
	vIOReturnStillOpen         int64 = C.kIOReturnStillOpen
	vIOReturnRLDError          int64 = C.kIOReturnRLDError
	vIOReturnDMAError          int64 = C.kIOReturnDMAError
	vIOReturnBusy              int64 = C.kIOReturnBusy
	vIOReturnTimeout           int64 = C.kIOReturnTimeout
	vIOReturnOffline           int64 = C.kIOReturnOffline
	vIOReturnNotReady          int64 = C.kIOReturnNotReady
	vIOReturnNotAttached       int64 = C.kIOReturnNotAttached
	vIOReturnNoChannels        int64 = C.kIOReturnNoChannels
	vIOReturnNoSpace           int64 = C.kIOReturnNoSpace
	vIOReturnPortExists        int64 = C.kIOReturnPortExists
	vIOReturnCannotWire        int64 = C.kIOReturnCannotWire
	vIOReturnNoInterrupt       int64 = C.kIOReturnNoInterrupt
	vIOReturnNoFrames          int64 = C.kIOReturnNoFrames
	vIOReturnMessageTooLarge   int64 = C.kIOReturnMessageTooLarge
	vIOReturnNotPermitted      int64 = C.kIOReturnNotPermitted
	vIOReturnNoPower           int64 = C.kIOReturnNoPower
	vIOReturnNoMedia           int64 = C.kIOReturnNoMedia
	vIOReturnUnformattedMedia  int64 = C.kIOReturnUnformattedMedia
	vIOReturnUnsupportedMode   int64 = C.kIOReturnUnsupportedMode
	vIOReturnUnderrun          int64 = C.kIOReturnUnderrun
	vIOReturnOverrun           int64 = C.kIOReturnOverrun
	vIOReturnDeviceError       int64 = C.kIOReturnDeviceError
	vIOReturnNoCompletion      int64 = C.kIOReturnNoCompletion
	vIOReturnAborted           int64 = C.kIOReturnAborted
	vIOReturnNoBandwidth       int64 = C.kIOReturnNoBandwidth
	vIOReturnNotResponding     int64 = C.kIOReturnNotResponding
	vIOReturnIsoTooOld         int64 = C.kIOReturnIsoTooOld
	vIOReturnIsoTooNew         int64 = C.kIOReturnIsoTooNew
	vIOReturnNotFound          int64 = C.kIOReturnNotFound
)
